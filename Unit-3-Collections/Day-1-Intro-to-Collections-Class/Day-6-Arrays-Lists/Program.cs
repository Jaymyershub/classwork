...
class Program
{
    static void Main(string[] args)
    {
        ...
        // List<data type> name = new List<datatype>(); // DONT FORGET THE ()
        ...
        //
        // standard syntax: for(i=0; i < listName.Length; i++)
        //
        //  listName.Count represents the number of elements in the List
       ...
       //Since our list starts off empty, we cant us .Count to control our loop
