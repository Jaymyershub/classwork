...
//C# groups things in namespaces
package PlayingCard; //Java groups things in packages - package name must match folder name
...
public class PlayingCard
{
     ...
     * Java: final so it cant be changed
     ***************************************************************************************************/
//                            datatype  variable-name    = initial-value  ;
    ...
    //  C#: bool
    //  Java: boolean
    private boolean      _faceUp; // true if card is face up; false if not
    ...
    public boolean is_faceUp() {
        return _faceUp;
    }

    public void set_faceUp(boolean _faceUp) {
        this._faceUp = _faceUp;
    }
